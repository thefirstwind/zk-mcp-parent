...
import com.zkinfo.util.McpToolSchemaGenerator;
...
public class VirtualProjectRegistrationService {
    ...
    public void registerVirtualProjectToNacos(Project virtualProject, VirtualProjectEndpoint endpoint) {
        try {
            ...
            List<com.zkinfo.model.ProviderInfo> aggregatedProviders = aggregateProviders(projectServices);
     ...
     */
    private List<com.zkinfo.model.ProviderInfo> aggregateProviders(List<ProjectService> projectServices) {
        Map<String, com.zkinfo.model.ProviderInfo> uniqueProviders = new LinkedHashMap<>();
        ...
        for (ProjectService projectService : projectServices) {
            ...
            List<com.zkinfo.model.ProviderInfo> allProviders = providerService.getAllProviders();
            log.debug("Total providers available: {}", allProviders.size());
            
            List<com.zkinfo.model.ProviderInfo> providers = allProviders.stream()
                    .filter(p -> {
            ...
            for (com.zkinfo.model.ProviderInfo provider : providers) {
    ...
    public List<Map<String, Object>> getVirtualProjectTools(Long virtualProjectId) {
        ...
        List<com.zkinfo.model.ProviderInfo> providers = aggregateProviders(projectServices);
     ...
     */
    private List<Map<String, Object>> generateToolsFromProviders(List<com.zkinfo.model.ProviderInfo> providers) {
